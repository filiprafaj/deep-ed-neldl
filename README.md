This code is a copy of https://github.com/dalab/end2end_neural_el/tree/master/deep-ed/deep-ed-master with minor changes only in the [relatedness.lua](entities/relatedness/relatedness.lua). [[1]](#1)
